            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
                ...
                <div
                    className={cn(
                        ...
                        'lg:transform-none lg:z-auto bg-white lg:bg-transparent overflow-auto'
                    )}
                >
                    <Card className="h-full flex flex-col border-0 lg:border rounded-none lg:rounded-lg shadow-none lg:shadow-lg">
                        <CardHeader className="sticky top-0 z-10 bg-white border-b lg:border-none flex flex-row items-center justify-between">
