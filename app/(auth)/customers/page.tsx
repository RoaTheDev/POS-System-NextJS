...
import {FileEdit, Filter, Plus, RefreshCcw, Search, Trash2, User, UserPlus, Users,} from 'lucide-react';
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                {isAdmin && <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    onClick={() => isAdmin && setCustomerToDelete(customer)}
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setCustomerToEdit(prev => ({
                                        ...prev!,
                                        phone: Number(e.target.value) || prev!.phone
                                    }))}
                                />
                            </div>
                            <div className="space-y-2">
